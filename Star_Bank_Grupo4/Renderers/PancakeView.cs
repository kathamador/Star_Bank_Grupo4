using System;
using Star_Bank_Grupo4.Styles;
using Xamarin.Forms;

namespace Star_Bank_Grupo4.Renderers
{
    public class PancakeView : ContentView
    {
        ...
        public static readonly BindableProperty BackgroundGradientStopsProperty = BindableProperty.Create(nameof(BackgroundGradientStops), typeof(Styles.GradientStopCollection), typeof(PancakeView), defaultValue: default(Styles.GradientStopCollection),
        defaultValueCreator: bindable =>
        {
            return new Styles.GradientStopCollection();
        });
        ...
        public static readonly BindableProperty BorderGradientStopsProperty = BindableProperty.Create(nameof(BorderGradientStops), typeof(Styles.GradientStopCollection), typeof(PancakeView), defaultValue: default(Styles.GradientStopCollection),
        defaultValueCreator: bindable =>
        {
            return new Styles.GradientStopCollection();
        });
        ...
        public Styles.GradientStopCollection BackgroundGradientStops
        {
            get { return (Styles.GradientStopCollection)GetValue(BackgroundGradientStopsProperty); }
        ...
        public Styles.GradientStopCollection BorderGradientStops
        {
            get { return (Styles.GradientStopCollection)GetValue(BorderGradientStopsProperty); }
